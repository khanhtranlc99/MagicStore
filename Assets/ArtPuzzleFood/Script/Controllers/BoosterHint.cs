 ...
 public void HandleHint()
{
        ...
        {
            temp.pieces.ScrollPieceIntoView(delegate
            {
                Main();
            });
        }    
        ...
        void Main()
        {
            currentHandHint = SimplePool2.Spawn(handTut);
            currentHandHint.transform.SetParent(postCanvas, false);
            currentHandHint.Init(temp.pieces.transform, temp.transform);
        }
